...
CREATE TABLE IF NOT EXISTS public.employees (
    ...
    name TEXT NOT NULL,
    category TEXT NOT NULL CHECK (category IN ('ab', 'cd', 'huolto', 'sijainen', 'kommentit')),
    type TEXT NOT NULL CHECK (type IN ('vakityontekija', 'sijainen')),
    role TEXT NOT NULL CHECK (role IN ('tj', 'varu1', 'varu2', 'varu3', 'varu4', 'pasta1', 'pasta2', 'ict', 'tarvike', 'pora', 'huolto', 'kommentit')),
